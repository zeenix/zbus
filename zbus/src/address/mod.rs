...
mod tests {
    ...
    #[cfg(windows)]
    use crate::address::transport::Autolaunch;
    #[cfg(target_os = "macos")]
    ...
    fn parse_dbus_addresses() {
        ...
        assert_eq!(
            ...
            Transport::Autolaunch(Autolaunch::new().set_scope(Some("*my_cool_scope*"))).into(),
        );
        #[cfg(target_os = "macos")]
        assert_eq!(
        ...
        assert_eq!(
            ...
            Transport::Vsock(super::transport::Vsock::new(98, 2934))
                .into()
                .set_guid(guid),
        );
        assert_eq!(
    ...
    fn stringify_dbus_addresses() {
        ...
        assert_eq!(
            Address::from(Transport::Autolaunch(
                Autolaunch::new().set_scope(Some("*my_cool_scope*"))
            ))
            .to_string(),
        ...
        #[cfg(all(feature = "vsock", not(feature = "tokio")))]
        {
            ...
            assert_eq!(
                Address::from(
                    Transport::Vsock(super::transport::Vsock::new(98, 2934)).set_guid(guid)
                )
                .to_string(),
