...
pub enum Error {
    ...
    IncompatibleFormat(Signature, crate::wire::serialized::Format),
    ...
    SignatureParse(crate::wire::signature::Error),
...
/// Alias for a `Result` with the error type `zbus::wire::Error`.
