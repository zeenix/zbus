...
#[test]
fn f64_value() {
    let encoded = f64_type_test(99999.99999_f64, 8, 16);
...
#[allow(dead_code)]
pub fn f64_type_test_as_value(value: f64, expected_value_len: usize) {
...
#[allow(dead_code)]
pub fn f64_value_test(v: Value<'_>, expected_value_len: usize) {
